...
struct Video : Decodable {
    ...
    init(from decoder: Decoder) throws
    {
        ...
        let higherContainer = try thumbnailContainer.nestedContainer(keyedBy: CodingKeys.self, forKey: .high)
        
        self.thumbnail = try higherContainer.decode(String.self, forKey: .thumbnail)
